---
name: gadd-setup
description: Run /gadd:setup to bootstrap a target repository for GADD. Use when the user says /gadd:setup, asks to set up GADD in a repo, or needs .gadd/config.yml, docs/work-items, local ledger support, and GADD templates created.
---
...
- safe destination directories for `.gadd/` and `docs/work-items/`
...
- Every Work Item starts in `docs/work-items/_drafts/YYYY-MM-DD-short-slug/` with a `ledger.yml`.
